 ...
 * in the j​​​​​​​​​​​th​​​​ bank. Return the wealth that the richest customer has. A customer's wealth is the amount of money
...
var maximumWealth = function (accounts) {
    ...
    accounts.map(account => max = Math.max(max, account.reduce((p,c) => p + c),0));
